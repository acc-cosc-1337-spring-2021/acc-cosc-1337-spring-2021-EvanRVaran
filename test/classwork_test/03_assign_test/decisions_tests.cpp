...
TEST_CASE("Test get letter grade using if function", "return letter grade for that number")
{
...
TEST_CASE("Test get letter grade using switch function", "return letter grade for that number")
{
